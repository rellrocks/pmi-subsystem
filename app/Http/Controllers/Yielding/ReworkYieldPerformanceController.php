...
class ReworkYieldPerformanceController extends Controller
{
    ...
    public function searchdisplaypyarework(Request $request)
    {
        $table = "tbl_yielding_performance";
        $pono = $request->pono;  
        $dataexist = DB::connection($this->mysql)->table($table)
    ...
    public function reworkgetautovalue(Request $request)
    {
        $pono = $request->pono;
    ...
    public function reworkgetpng(Request $request)
    {
        $pono = $request->pono;
    ...
    public function reworkgetmng(Request $request)
    {
        $pono = $request->pono;
        $table = DB::connection($this->mysql)->table('tbl_yielding_performance')
    ...
    public function searchdisplaycmqrework(Request $request)
    {
        $table = "tbl_yielding_performance";
        $pono = $request->pono;
        $dataexist = DB::connection($this->mysql)->table($table)
    ...
    public function searchdisplaydetailsrework(Request $request)
    {
        $table = "tbl_yielding_performance";
        $pono = $request->pono;
        $dataexist = DB::connection($this->mysql)->table($table)
    ...
    public function addreworkYieldperformance(Request $req)
    {
        if(isset($req->newyieldingstation)){
            ...
            if ($req->id !== '' || !empty($req->id)) {
                $updated = DB::connection($this->mysql)->table("tbl_secondpassedyielding_performance")
                            ->where('id',$req->id)
                            ->update([
                                'pono' => $req->pono,
                                'poqty' => $req->poqty,
                ...
                DB::connection($this->mysql)->table('tbl_secondpassedyielding_pya')
                ...
                $inserted = DB::connection($this->mysql)->table("tbl_secondpassedyielding_performance")
                                ->insert([
                                    'pono' => $req->pono,
                                    'poqty' => $req->poqty,
                                    'device' => $req->device,
                ...
                $last_insert = DB::connection($this->mysql)->table("tbl_secondpassedyielding_performance")
                        ->select('id')
                        ->orderBy('id','desc')
                        ->first();
    ...
    public function reworksearchPO(Request $request)
    {    
        $search = $request->data;
        $find = $search['pono'];
    ...
    public function searchrework(Request $request)
    {    
        $search = $request->data;
        $find = $search['search'];
       /* return $find;*/
    ...
    public function deleteAllPostrework(Request $request)
    {      
        $tray = $request->tray;
    ...
    public function deletecmqrework(Request $request)
    {      
        $tray = $request->tray;
        $traycount = $request->traycount;
    ...
    public function deletepyarework(Request $request)
    {
        $tray = $request->tray;
        $traycount = $request->traycount;
        $yield_id = $request->id;
    ...
    //CER
    public function GetPONumberDetailsrework(Request $req)
    {
        $podetails = '';
        $pya = '';
        $cmq = '';
        $save_details = DB::connection($this->mysql)
                            ->table('tbl_secondpassedyielding_performance')
                            ->where('pono',$req->po)
                            ->select(
                                'id',
                                'pono',
        ...
        if (count((array)$save_details) < 1) {
            $localpo = DB::connection($this->mysql)
                                ->table('tbl_yielding_performance')
                                ->where('pono',$req->po)
                                ->select('pono','poqty','device','family','series','prodtype','qty','tinput','treject')
                                ->first();
            ...
            $pya = DB::connection($this->mysql)->table('tbl_secondpassedyielding_pya')
                        ->where('pono','=',$req->po)
                        ->select('id','yield_id','productiondate','yieldingstation','accumulatedoutput','classification','mod','rework','qty','remarks')
                        ->orderBY('productiondate','DESC')
                        ->get();
    ...
    public function GetFianlVisualInspection(Request $req){
      ...
      public function GetModdeffects(Request $req){
