            ...
            <form class=form-horizontal method="POST" action="{{ url('/oqc-save-inspection') }}" id="frm_inspection">
                <div class="modal-body">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td width="50%">
                                <div class="form-group" id="lot_inspected_div">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" min="0" max="1" class="form-control enter input-sm validate clear" id="lot_inspected" name="lot_inspected">
                                        <span class="help-block">
                                ...
                                <div class="form-group" id="lot_accepted_div">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" min="0" max="1" class="form-control enter input-sm validate clear" id="lot_accepted" name="lot_accepted">
                                        <span class="help-block">
                        ...
                        <tr>
                            <th colspan="2" class="text-right">
                                <button type="submit" class="btn btn-success" id="btn_savemodal" @if($is_supervisor == 0) {{ 'disabled' }}@endif>Save</button>
                                <button type="button" data-dismiss="modal" class="btn btn-danger">Close</button>
                            </th>
                        </tr>
                    </table>
