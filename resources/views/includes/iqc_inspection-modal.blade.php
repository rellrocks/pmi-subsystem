					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<select id="lot_no" name="lot_no[]" multiple="multiple" class="form-control required input-sm clear lot_no clearselect" <?php echo($state);?>>
									</select>
			...
			<form class="form-horizontal">
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label class="control-label col-sm-3">Lot No.:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control input-sm show-tick" name="sorting_lot_no" id="sorting_lot_no">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" id="sorting_total_qty" name="sorting_total_qty" class="form-control input-sm">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" id="sorting_good_qty" name="sorting_good_qty" class="form-control input-sm">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" id="sorting_ng_qty" name="sorting_ng_qty" class="form-control input-sm">
							...
							<div class="form-group">
								<label class="control-label col-sm-3">Remarks:</label>
								<div class="col-sm-5">
									<input type="text" id="sorting_remarks" name="sorting_remarks" class="form-control input-sm">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table table-hover table-bordered table-striped table-fixedheader" id="tbl_sorting">
									<thead>
										<tr>
			...
			<form class="form-horizontal">
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label class="control-label col-sm-3">Lot No.:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control input-sm show-tick" name="rework_lot_no" id="rework_lot_no">
							...
							<div class="form-group">
								<label class="control-label col-sm-3">Total Quantity:</label>
								<div class="col-sm-5">
									<input type="text" id="rework_total_qty" name="rework_total_qty" class="form-control input-sm">
							...
							<div class="form-group">
								<label class="control-label col-sm-3">Good Quantity:</label>
								<div class="col-sm-5">
									<input type="text" id="rework_good_qty" name="rework_good_qty" class="form-control input-sm">
							...
							<div class="form-group">
								<label class="control-label col-sm-3">NG Quantity:</label>
								<div class="col-sm-5">
									<input type="text" id="rework_ng_qty" name="rework_ng_qty" class="form-control input-sm">
							...
							<div class="form-group">
								<label class="control-label col-sm-3">Remarks:</label>
								<div class="col-sm-5">
									<input type="text" id="rework_remarks" name="rework_remarks" class="form-control input-sm">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table table-hover table-bordered table-striped table-fixedheader" id="tbl_rework">
									<thead>
										<tr>
											<td class="table-checkbox">
                                                <input type="checkbox" class="group-checkable checkAllitemsinspection" />
			...
			<form class="form-horizontal">
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label class="control-label col-sm-3">Lot No.:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control input-sm show-tick" name="rtv_lot_no" id="rtv_lot_no">
							...
							<div class="form-group">
								<label class="control-label col-sm-3">Total Quantity:</label>
								<div class="col-sm-5">
									<input type="text" id="rtv_total_qty" name="rtv_total_qty" class="form-control input-sm">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" id="rtv_category" name="rtv_category" class="form-control input-sm">
							...
							<div class="form-group">
								<label class="control-label col-sm-3">Remarks:</label>
								<div class="col-sm-5">
									<input type="text" id="rtv_remarks" name="rtv_remarks" class="form-control input-sm">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table table-hover table-bordered table-striped table-fixedheader" id="tbl_rtv">
									<thead>
										<tr>
											<td class="table-checkbox">
                                                <input type="checkbox" class="group-checkable checkAllitemsinspection" />
