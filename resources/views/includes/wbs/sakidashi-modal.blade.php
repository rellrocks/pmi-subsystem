		...
		<div class="modal-content blue">
			...
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" id="srch_tbl" style="font-size:10px">
								<thead>
									<tr>
										<td></td>
...
<div id="ConfirmModal" class="modal fade" role="dialog" data-backdrop="static">
	<div class="modal-dialog modal-sm blue">
		<form role="form" method="POST" action="{{url('/sakidashi-issuance/cancel-po')}}" id="frm_cancel">
			<div class="modal-content ">
				<div class="modal-body">
