		...
		<div class="modal-content ">
			...
			<div class="modal-body">
				<div class="row" id="row_d">
					...
					<div class="col-md-8 cold_d">
						<table class="table table-bordered table-striped table-fifo" style="font-size:10px; white-space: nowrap;" id="tbl_fifo">
							<thead>
								<tr>
									{{-- <td width="7.28%"></td>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary nxt_item" id="btn_nxt_item">Next Item</button>
...
<div id="fifoReasonModal" class="modal fade" role="dialog" data-backdrop="static">
	<div class="modal-dialog gray-gallery">
		<div class="modal-content ">
			...
			<div class="modal-body">
				<p>FIFO is recommended, but you can specify your reason for using this Lot number.</p>
				<input type="hidden" name="next_row_indx" id="next_row_indx">
				<input type="hidden" name="fr_id" id="fr_id">
				<input type="hidden" name="fr_prev_id" id="fr_prev_id">
				<input type="hidden" name="fr_item" id="fr_item">
				<input type="hidden" name="fr_item_desc" id="fr_item_desc">
				<input type="hidden" name="fr_qty" id="fr_qty">
				<input type="hidden" name="fr_lot_no" id="fr_lot_no">
				<input type="hidden" name="fr_location" id="fr_location">
				<input type="hidden" name="fr_kit_qty" id="fr_kit_qty">
				<div class="col-md-12">
...
<div id="enableModal" class="modal fade" role="dialog" data-backdrop="static">
	<div class="modal-dialog gray-gallery">
		<div class="modal-content ">
			<div class="modal-header">
				<h4 id="tit" class="modal-title">Re-enable Item</h4>
			</div>
			<div class="modal-body">
				<p>Please enter authorized User Credential and state your reason for re-enabling this item.</p>
				<input type="hidden" name="enable_id" id="enable_id">
				<input type="hidden" name="enable_row_id" id="enable_row_id">
				<input type="hidden" name="enable_prev_row_id" id="enable_prev_row_id">
				<input type="hidden" name="enable_item" id="enable_item">
				<input type="hidden" name="enable_itemdesc" id="enable_itemdesc">
				<input type="hidden" name="enable_qty" id="enable_qty">
				<input type="hidden" name="enable_lotno" id="enable_lotno">
				<input type="hidden" name="enable_location" id="enable_location">
				<input type="hidden" name="enable_kitqty" id="enable_kitqty">
				<div class="col-md-12">
					<form class="form-horizontal">
						<div class="form-group">
							<label class="col-md-3 control-label"><i class="fa fa-user"></i> Username:</label>
							<div class="col-md-9">
								<input type="text" class="form-control input-sm" id="enable_user_id"name="enable_user_id" autofocus>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-md-3 control-label"><i class="fa fa-lock"></i> Password:</label>
							<div class="col-md-9">
								<input type="password" class="form-control input-sm" id="enable_password" name="enable_password">
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label"><i class=""></i>Reason:</label> 
							<div class="col-md-9">
								<textarea class="col-md-3 form-control" id="enable_reason" style="resize:none;" rows="4"></textarea>  
							</div>
						</div>
					</form>
				</div>
			...
			<div class="modal-footer">
				<button type="button" id="btn_enable" class="btn btn-success">OK</button>
				<button type="button" data-dismiss="modal" class="btn btn-danger">Close</button>
			</div>
		</div>
	</div>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							...
							<div class="form-group">
								<label class="control-label col-sm-2">PORDER</label>
								<div class="col-sm-9">
									<input type="text" class="form-control input-sm mask_kitqty" id="kittinglist_porder" name="kittinglist_porder">
								</div>
							</div>
						</div>
					</div>
