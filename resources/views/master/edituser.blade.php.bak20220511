																...
																<tbody>
																	@foreach ($eypprog as $eypprg)
																		<tr>
																			...
																			<td>
																				<input type="checkbox" class="checkboxes rw EYPrw" name="rw[]" value="{{$eypprg->program_code}}" 
																				{{$state}}
																					@if (isset($progs[$eypprg->program_code]))
																						@if ($progs[$eypprg->program_code] == 1)
																							{{"checked"}}
																						@endif
																					@endif
																				/>
																			...
																			<td>
																				<input type="checkbox" class="checkboxes r EYPr" name="r[]" value="{{$eypprg->program_code}}"
																				 {{$state}}
																					@if (isset($progs[$eypprg->program_code]))
																						@if ($progs[$eypprg->program_code] == 2)
																							{{"checked"}}
																						@endif
																					@endif
																				/>
																...
																<tbody>
																	@foreach ($dataextraction as $dtextr)
																		<tr>
																			...
																			<td>
																				<input type="checkbox" class="checkboxes rw yprw" name="rw[]" value="{{$dtextr->program_code}}" <?php echo($state); ?>
																					@if (isset($progs[$dtextr->program_code]))
																						@if ($progs[$dtextr->program_code] == 1)
																							{{"checked"}}
																						@endif
																					@endif
																				/>
																			...
																			<td>
																				<input type="checkbox" class="checkboxes r ypr" name="r[]" value="{{$dtextr->program_code}}" <?php echo($state); ?> 
																					@if (isset($progs[$dtextr->program_code]))
																						@if ($progs[$dtextr->program_code] == 2)
																							{{"checked"}}
																						@endif
																					@endif
																				/>
