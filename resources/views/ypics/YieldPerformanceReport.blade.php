...
@section('title')
     Yield Performance Reports | Pricon Microelectronics, Inc.
@endsection
...
@section('content')
     ...
     @foreach ($userProgramAccess as $access)
          @if ($access->program_code == Config::get('constants.MODULE_CODE_REP'))  
               ...
               <div class="col-sm-12">
                    ...
                    <div class="portlet box blue" >
                         <div class="portlet-title">
                              <div class="caption">
                                   <i class="fa fa-navicon"></i>  Yield Performance Reports
                              </div>
                         </div>
