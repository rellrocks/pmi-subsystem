...
@section('title')
     Mode Of Defects | Pricon Microelectronics, Inc.
@endsection
...
@section('content')
     ...
     @foreach ($userProgramAccess as $access)
          @if ($access->program_code == Config::get('constants.MODULE_CODE_MOD'))  <!-- Please update "2001" depending on the corresponding program_code -->
               ...
               <div class="col-sm-12">
                    ...
                    <div class="portlet box blue" >
                         <div class="portlet-title">
                              <div class="caption">
                                   <i class="fa fa-navicon"></i>  MODE OF DEFECTS
                              </div>
                         </div>
