...
$(function () {
    ...
    // on modal shown
    $("#IQCresultModal").on("shown.bs.modal", function () {
        $('#partcode').select2({
            // placeholder: 'Select an item',
            // ajax: {
            //     url: "{{url('/iqcdbgetitems')}}" + '?invoiceno=' + $('#invoice_no').val(),
            //     dataType: 'json',
            //     delay: 200,
            //     data: function (data) {
            //         return {
            //             invoiceno: data.term // search term
            //         };
            //     },
    ...
    $('#tblforiqcinspection').on('click', '.btn_editiqc', function () {
        ...
        $('#status_NGR').val($(this).attr('data-ngr_status'));
        $('#disposition_NGR').val($(this).attr('data-ngr_disposition'));
        ...
        if ($(this).attr('data-judgement') == "Rejected") {
            ...
            $('#btn_sorting').removeClass('hidden');
            $('#btn_sorting').show();
            $('#btn_rework').removeClass('hidden');
            $('#btn_rework').show();
            $('#btn_rtv').removeClass('hidden');
            $('#btn_rtv').show();
            $('.ngr_details').show();
        } else {
            $('#btn_special_accept').addClass('hidden');
            $('#btn_special_accept').hide();
            $('#btn_sorting').addClass('hidden');
            $('#btn_sorting').hide();
            $('#btn_rework').addClass('hidden');
            $('#btn_rework').hide();
            $('#btn_rtv').addClass('hidden');
            $('#btn_rtv').hide();
            $('.ngr_details').hide();
        }
    ...
    $('#tblforongoing').on('click', '.btn_editongiong', function () {
        ...
        getItemDetailsEdit($(this).attr('data-partcode'));
