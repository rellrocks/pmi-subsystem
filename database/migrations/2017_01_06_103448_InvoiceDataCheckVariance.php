...
class InvoiceDataCheckVariance extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('invoice_data_check_variance', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('invoice_data_check_variance');
    }
}
