...
class CreateWbsMaterialReceivingBatchTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_wbs_material_receiving_batch', function (Blueprint $table) {
    ...
    {
        Schema::drop('tbl_wbs_material_receiving_batch');
    }
}
